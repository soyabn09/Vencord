...
function ContributorModal({ user }: { user: User }) {
    ...
    const ContributedHyperLink = (
        <Link href="https://vencord.dev/source">contributed</Link>
    );
    ...
    return (
        <>
            <div className={cl("header")}>
                ...
                <div
                    className={classes("vc-settings-modal-links", cl("links"))}
                >
                    {website && (
                        <WebsiteButton
                            text={website}
            ...
            {plugins.length ? (
                <Forms.FormText>
                    This person has {ContributedHyperLink} to{" "}
                    {pluralise(plugins.length, "plugin")}!
                </Forms.FormText>
            ) : (
                <Forms.FormText>
                    This person has not made any plugins. They likely{" "}
                    {ContributedHyperLink} to Vencord in other ways!
                </Forms.FormText>
            )}
