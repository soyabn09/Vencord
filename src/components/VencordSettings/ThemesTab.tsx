...
function Validators({ themeLinks }: { themeLinks: string[] }) {
    ...
    return (
        <>
            <Forms.FormTitle className={Margins.top20} tag="h5">
                Validator
            </Forms.FormTitle>
            <Forms.FormText>
                This section will tell you whether your themes can successfully
                be loaded
            </Forms.FormText>
            <div>
...
function ThemesTab() {
    ...
    const [themeDir, , themeDirPending] = useAwaiter(
        VencordNative.themes.getThemesDir,
    );
        ...
        return (
            <>
                <Card className="vc-settings-card vc-text-selectable">
                    ...
                    <Forms.FormText>
                        Make sure to use direct links to files (raw or
                        github.io)!
                    </Forms.FormText>
                </Card>
