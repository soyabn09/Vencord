...
export function NotificationSettings() {
    ...
    return (
        <div style={{ padding: "1em 0" }}>
            ...
            {settings.useNative !== "never" &&
                Notification?.permission === "denied" && (
                    ...
                    >
                        ...
                        <Forms.FormText>
                            You have denied Notification Permissions. Thus,
                            Desktop notifications will not work!
                        </Forms.FormText>
                    </ErrorCard>
                )}
            <Forms.FormText className={Margins.bottom8}>
                Some plugins may show you notifications. These come in two
                styles:
                <ul>
                    <li>
                        <strong>Vencord Notifications</strong>: These are in-app
                        notifications
                    </li>
                    <li>
                        <strong>Desktop Notifications</strong>: Native Desktop
                        notifications (like when you get a ping)
                    </li>
                </ul>
            </Forms.FormText>
            <Select
                ...
                options={
                    [
                        ...
                        { value: (typeof settings)["useNative"] } & Record<
                            string,
                            any
                        >
                    >
            ...
            <Forms.FormTitle
                tag="h5"
                className={Margins.top16 + " " + Margins.bottom8}
            >
            ...
            <Select
                ...
                options={
                    [
                        ...
                        { value: (typeof settings)["position"] } & Record<
                            string,
                            any
                        >
                    >
            ...
            <Forms.FormText className={Margins.bottom16}>
                The amount of notifications to save in the log until old ones
                are removed. Set to <code>0</code> to disable Notification log
                and <code>∞</code> to never automatically remove old
                Notifications
            </Forms.FormText>
            <Slider
