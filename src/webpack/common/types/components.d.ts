...
export type Margins = Record<
    ...
    string
>;
export type ButtonLooks = Record<
...
export type TooltipContainer = ComponentType<
    PropsWithChildren<{
        text: ReactNode;
        element?: "div" | "span";
...
export type TextArea = ComponentType<
    PropsWithRef<
...
export type Select = ComponentType<
    PropsWithChildren<{
        placeholder?: string;
...
export type SearchableSelect = ComponentType<
    PropsWithChildren<{
        placeholder?: string;
        options: ReadonlyArray<SelectOption>; // TODO
        value?: SelectOption;
