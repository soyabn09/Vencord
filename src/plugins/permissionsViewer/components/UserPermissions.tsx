...
import openRolesAndUsersPermissionsModal, {
    PermissionType,
    type RoleOrUserPermission,
} from "./RolesAndUsersPermissions";
        ...
        <ExpandableHeader
            ...
            onMoreClick={() =>
                openRolesAndUsersPermissionsModal(
                    ...
                    guild,
                    guildMember.nick ||
                        UserStore.getUser(guildMember.userId).username,
                )
            }
