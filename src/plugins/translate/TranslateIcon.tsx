...
export let setShouldShowTranslateEnabledTooltip:
    | undefined
    | ((show: boolean) => void);
...
export const TranslateChatBarIcon: ChatBarButton = ({ isMainChat }) => {
                ...
                body: (
                    <>
                        <Forms.FormText>
                            ...
                            <b>will automatically be translated</b> before being
                            sent.
                        </Forms.FormText>
                    </>
                ),
    ...
    if (
        shouldShowTranslateEnabledTooltip &&
        settings.store.showAutoTranslateTooltip
    )
        return (
