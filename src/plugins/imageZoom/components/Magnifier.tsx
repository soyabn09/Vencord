...
export const Magnifier = ErrorBoundary.wrap<MagnifierProps>(
    ({ instance, size: initialSize, zoom: initalZoom }) => {
        ...
        React.useLayoutEffect(() => {
            ...
            const syncVideos = () => {
                if (
                    ...
                    currentVideoElementRef.current.currentTime =
                        originalVideoElementRef.current.currentTime;
            };
            ...
            waitFor(
                ...
                () => {
                    ...
                    if (instance.props.animated) {
                        ...
                        originalVideoElementRef.current.addEventListener(
                            "timeupdate",
                            syncVideos,
                        );
                    }
        ...
        return (
            <div
                className={cl("lens", {
                    "nearest-neighbor": settings.store.nearestNeighbour,
                    square: settings.store.square,
                })}
                style={{
                    opacity,
            ...
            >
                {instance.props.animated ? (
                    <video
                        ...
                        src={
                            originalVideoElementRef.current?.src ??
                            instance.props.src
                        }
                        autoPlay
                        loop
