...
const ChannelListClasses = findByPropsLazy(
    "modeMuted",
    "modeSelected",
    "unread",
    "icon",
        ...
        options: [
            {
                ...
                value: ShowMode.LockIcon,
                default: true,
            },
            {
                label: "Muted style with hidden eye icon on the right",
                value: ShowMode.HiddenIconWithMutedStyle,
            },
        ],
        restartNeeded: true,
    },
    ...
    patches: [
        {
            ...
            replacement: [
                ...
                // Make channels we dont have access to be the same level as normal ones
                {
                    ...
                    replace: (_, rest, defaultRenderLevel) =>
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (m, channel) =>
                        `${m}$self.isHiddenChannel(${channel},true)||`,
                },
            ],
        },
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (_, channel) =>
                    `if($self.isHiddenChannel(${channel}))return $self.LockIcon;`,
            },
        },
        {
            find: "UNREAD_IMPORTANT:",
            predicate: () =>
                settings.store.showMode === ShowMode.HiddenIconWithMutedStyle,
            replacement: [
                // Make the channel appear as muted if it's hidden
                {
                    match: /{channel:(\i),name:\i,muted:(\i).+?;/,
                    replace: (m, channel, muted) =>
                        `${m}${muted}=$self.isHiddenChannel(${channel})?true:${muted};`,
                },
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (m, channel, unread) =>
                        `${m}${unread}=$self.isHiddenChannel(${channel})?false:${unread};`,
                },
            ],
        },
        {
            ...
            replacement: [
                {
                    ...
                    replace: (
                        _,
                        pushNotificationButtonExpression,
                        channel,
                        isLurking,
                    ) =>
                        `if(!${isLurking}&&$self.isHiddenChannel(${channel})){${pushNotificationButtonExpression};break;}`,
                },
                {
                ...
                },
                {
                    ...
                    replace: (m, channel) =>
                        `${m}if($self.isHiddenChannel(${channel}))break;`,
                },
                {
        ...
        // Avoid trying to fetch messages from hidden channels
        {
            ...
            replacement: {
                ...
                replace: (m, channelId) =>
                    `${m}if($self.isHiddenChannel({channelId:${channelId}}))return;`,
            },
        },
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (m, channel) =>
                        `${m}.reduce(...$self.makeAllowedRolesReduce(${channel}.guild_id))`,
                },
                {
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (_, amount) =>
                        `($self.isHiddenChannel(typeof shcChannel!=="undefined"?shcChannel:void 0,true)&&${amount}<=0?0:1)`,
                },
                {
                    ...
                    match: /(?<="\+",)(\i)\+1/,
                    replace: (m, amount) =>
                        `$self.isHiddenChannel(typeof shcChannel!=="undefined"?shcChannel:void 0,true)&&${amount}<=0?"":${m}`,
                },
            ],
        },
        {
            ...
            replacement: [
                {
                    ...
                    replace: (m, channel, inCall) =>
                        `${m}${inCall}||!$self.isHiddenChannel(${channel},true)&&`,
                },
                {
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (m, channel) =>
                        `${m}$self.isHiddenChannel(${channel})?null:`,
                },
                {
                ...
                },
                {
                    ...
                    replace: (m, channel) =>
                        `${m}$self.isHiddenChannel(${channel})?void 0:`,
                },
            ],
        },
        {
            ...
            replacement: [
                {
                    ...
                    replace: (m, channel) =>
                        `$self.isHiddenChannel(${channel})?null:(${m})`,
                },
                {
    ...
    makeAllowedRolesReduce(guildId: string) {
        return [
            (
                ...
                _: Role,
                index: number,
                originalArray: Array<Role>,
            ) => {
                if (index !== 0) return prev;

                const everyoneRole = originalArray.find(
