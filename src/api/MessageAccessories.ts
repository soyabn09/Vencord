...
export type AccessoryCallback = (
    props: Record<string, any>,
) => JSX.Element | null | Array<JSX.Element | null>;
...
export function _modifyAccessories(
    ...
    for (const accessory of accessories.values()) {
        ...
        if (!Array.isArray(accessories)) accessories = [accessories];
        else if (accessories.length === 0) continue;
